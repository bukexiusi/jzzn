    ...
    try:
        ...
        for input_path in input_path_array:
            ...
            for copy_index in range(copy_num):
                ...
                word.open_document(new_path)
                word.word.Selection.Find.Execute('<p>', False, False, False, False, False, True, 1, True, '^p', 2)
                word.word.Selection.Find.Execute('<p', False, False, False, False, False, True, 1, True, '^p', 2)
                word.save_document(new_path)
                if new_path2:
...
if __name__ == "__main__":
    ...
    case_excel = excelOperation.excel_to_dict_result_zn("案件列表", "案号", "(9102)闽0203执3469号")
    litigant_excel = excelOperation.excel_to_dict_result_zn("当事人列表", "案号", "(9102)闽0203执3469号")
    global case
    global litigants
    case = case_excel
