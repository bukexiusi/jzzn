...
doc = None
def open(path, Visible=0, DisplayAlerts=0, newProcess=False, Encoding="gbk"):
    word = Word(Visible, DisplayAlerts, newProcess)
    word.open_document(path, Encoding)
    return word

def read(word):
    return word.read_document_text()
